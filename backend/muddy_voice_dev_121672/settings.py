"""
Django settings for muddy_voice_dev_121672 project.
...
ROOT_URLCONF = 'muddy_voice_dev_121672.urls'
...
WSGI_APPLICATION = 'muddy_voice_dev_121672.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "muddy_voice_dev_121672 API",
    "DESCRIPTION": "API documentation for muddy_voice_dev_121672 App",
    "VERSION": "v1",
}
